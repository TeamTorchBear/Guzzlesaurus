...
public class AkPlatformInitSettings : IDisposable {
  ...
  public AkAudioSessionProperties audioSession {
    set {
      AkSoundEnginePINVOKE.CSharp_AkPlatformInitSettings_audioSession_set(swigCPtr, AkAudioSessionProperties.getCPtr(value));

    } 
    get {
      IntPtr cPtr = AkSoundEnginePINVOKE.CSharp_AkPlatformInitSettings_audioSession_get(swigCPtr);
      AkAudioSessionProperties ret = (cPtr == IntPtr.Zero) ? null : new AkAudioSessionProperties(cPtr, false);
