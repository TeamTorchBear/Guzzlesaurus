...
public class AkCallbackSerializer : IDisposable {
  ...
  public static AKRESULT AudioSourceChangeCallbackFunc(bool in_bOtherAudioPlaying, object in_pCookie) {
    AKRESULT ret = (AKRESULT)AkSoundEnginePINVOKE.CSharp_AkCallbackSerializer_AudioSourceChangeCallbackFunc(in_bOtherAudioPlaying, in_pCookie != null ? (IntPtr)in_pCookie.GetHashCode() : IntPtr.Zero);
