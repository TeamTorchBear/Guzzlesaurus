...
public class AkOutputSettings : IDisposable {
  ...
  public AkBusHierarchyFlags outputHierarchy {
    set {
      AkSoundEnginePINVOKE.CSharp_AkOutputSettings_outputHierarchy_set(swigCPtr, (int)value);

    } 
    get {
      AkBusHierarchyFlags ret = (AkBusHierarchyFlags)AkSoundEnginePINVOKE.CSharp_AkOutputSettings_outputHierarchy_get(swigCPtr);
